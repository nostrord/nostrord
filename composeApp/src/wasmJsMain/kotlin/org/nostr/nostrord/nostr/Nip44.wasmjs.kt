...
private external fun jsHkdfExtract(
    salt: Uint8Array,
    ikm: Uint8Array,
): Uint8Array

@JsFun("(prk, info, length) => globalThis.hkdfExpand(prk, info, length)")
private external fun jsHkdfExpand(
    prk: Uint8Array,
    info: Uint8Array,
    length: Int,
): Uint8Array
...
private external fun jsChacha20(
    key: Uint8Array,
    nonce: Uint8Array,
    data: Uint8Array,
): Uint8Array
...
private external fun jsHmacSha256(
    key: Uint8Array,
    data: Uint8Array,
): Uint8Array
...
private external fun jsConcatArrays(
    a: Uint8Array,
    b: Uint8Array,
): Uint8Array

@JsFun("(arr, start, end) => globalThis.sliceUint8Array(arr, start, end)")
private external fun jsSliceArray(
    arr: Uint8Array,
    start: Int,
    end: Int,
): Uint8Array
...
private external fun jsArraysEqual(
    a: Uint8Array,
    b: Uint8Array,
): Boolean
